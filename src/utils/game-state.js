...
/**
 * @import {Game, Story, GameSettings, ChatMessage, ChatHistoryItem} from '@/types.js'
 ...
 * @param {Story} caseFile - The case file/story generated for the game.
...
/**
 * Clears the 'talkingToTeamId' for any witness currently engaged by a specific user.
 * @param {string} gameId - The ID of the game.
 * @param {string} uid - The user's UID.
 * @returns {Promise<void>}
 */
export async function clearMyWitnessTalkingTo(gameId, uid) {
  ...
  if (witnesses) {
    ...
    witnesses.forEach((witness, index) => {
      if (witness.talkingToTeamId === uid) {
