    ...
    <v-row justify="center">
      <v-col cols="12" md="8">
        <v-card class="pa-4">
          ...
          <v-card-text>
            <h3 class="text-h6 mt-4 mb-2">Angaben gemäß § 5 DDG</h3>
            <p>
              Mutlu Can Yilmaz<br />
              Leharstraße 6<br />
              86179 Augsburg
            ...
            <h3 class="text-h6 mt-4 mb-2">Kontakt</h3>
            <p><strong>E-Mail:</strong> mtlcnylmz@gmail.com</p>

            <v-divider class="my-4"></v-divider>

            <h3 class="text-h6 mt-4 mb-2">Haftungsausschluss</h3>
            <h4 class="text-subtitle-1 mt-3">Haftung für Inhalte</h4>
            <p>
            ...
            <h4 class="text-subtitle-1 mt-3">Haftung für Links</h4>
            <p>
            ...
            <h4 class="text-subtitle-1 mt-3">Urheberrecht</h4>
            <p>
